  ...
  return (
    <div>
        ...
        <Link to={"/signup"}>
          ...
          <div className='group flex flex-row mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 w-fit'>
